...
"VeigarPrimordialBurst", "FioraDance", "NasusQAttack"};
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
          ...
          //  SimpleTs.AddToMenu(ts);
            ...
            var lxMenu = new Menu("LX_走砍", "LXOrb");  //lx
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("useSmite", "使用 智能连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("smartQ", "智能Q 躲技能").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("Qks", "Q 击杀").SetValue(true));
           ...
           // Config.SubMenu("Combo").AddItem(new MenuItem("MSdiff", "Movespeed difference for Q").SetValue(new Slider(50, 0, 200)));
            ...
            Game.PrintChat("<font color='#00FFFF'>Master Yi By Prunes</font><font color='#FFFFFF'> 鍔犺級鎴愬姛锛佹饥鍖朾y 鑺辫竟锛丵Q缇361630847!</font>");
        }
