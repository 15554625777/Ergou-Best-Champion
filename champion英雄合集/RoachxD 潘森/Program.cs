    ...
    internal class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Config.SubMenu("combo")
                .AddItem(new MenuItem("comboKey", "连招 键位").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            Config.SubMenu("harass")
                .AddItem(
                    new MenuItem("harassKey", "骚扰 键位").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("harass")
                .AddItem(new MenuItem("hMode", "骚扰 模式: ").SetValue(new StringList(new[] {"Q", "W+E"})));
            Config.SubMenu("harass")
                .AddItem(
                    new MenuItem("autoQ", "目标进入范围自动Q").SetValue(new KeyBind("Z".ToCharArray()[0],
                        KeyBindType.Toggle)));
            Config.SubMenu("harass")
                .AddItem(new MenuItem("aQT", "塔下禁用Q").SetValue(true));
            Config.SubMenu("harass").AddItem(new MenuItem("harassMana", "骚扰最低蓝量: ").SetValue(new Slider(50)));

            Config.AddSubMenu(new Menu("清线 设置", "farm"));
            Config.SubMenu("farm")
                .AddItem(
                    new MenuItem("farmKey", "清线 键位").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("farm").AddItem(new MenuItem("farmMana", "骚扰最低蓝量: ").SetValue(new Slider(50)));

            Config.AddSubMenu(new Menu("清野 设置", "jungle"));
            Config.SubMenu("jungle")
                .AddItem(
                    new MenuItem("jungleKey", "清野 键位").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            Config.SubMenu("drawing")
                .AddItem(
                    new MenuItem("Target", "显示所有范围").SetValue(new Circle(true,
                        Color.FromArgb(255, 255, 0, 0))));
            Config.SubMenu("drawing")
                .AddItem(
                    new MenuItem("QDraw", "显示 (Q) 范围").SetValue(new Circle(true,
                        Color.FromArgb(255, 178, 0, 0))));
            Config.SubMenu("drawing")
                .AddItem(
                    new MenuItem("WDraw", "显示 (W) 范围").SetValue(new Circle(false,
                        Color.FromArgb(255, 32, 178, 170))));
            Config.SubMenu("drawing")
                .AddItem(
                    new MenuItem("EDraw", "显示 (E) 范围").SetValue(new Circle(true,
                        Color.FromArgb(255, 128, 0, 128))));

            Config.AddSubMenu(new Menu("杂项 设置", "misc"));
            Config.SubMenu("misc").AddItem(new MenuItem("stopChannel", "中断 法术").SetValue(true));
            Config.SubMenu("misc").AddItem(new MenuItem("usePackets", "技能 封包").SetValue(false));
