    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                _config = new Menu("劫 Is Back", "Ze-D Is Back", true);
                ...
                _config.SubMenu("Combo").AddItem(new MenuItem("UseWC", "使用 W (敌人突进)")).SetValue(true);
                _config.SubMenu("Combo").AddItem(new MenuItem("UseIgnitecombo", "使用 点燃(可击杀)")).SetValue(true);
                _config.SubMenu("Combo").AddItem(new MenuItem("ActiveCombo", "连招!").SetValue(new KeyBind(32, KeyBindType.Press)));
                _config.SubMenu("Combo")
                    .AddItem(new MenuItem("TheLine", "连招（先R)").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                ...
                _config.SubMenu("items").AddSubMenu(new Menu("进攻物品", "Offensive"));
                ...
                _config.SubMenu("items")
                    .SubMenu("Offensive")
                    .AddItem(new MenuItem("BilgeEnemyhp", "敌人最小血量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("items")
                    .SubMenu("Offensive")
                   .AddItem(new MenuItem("Bilgemyhp", "自己最大血量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blade", "使用 破败")).SetValue(true);
                _config.SubMenu("items")
                    .SubMenu("Offensive")
                    .AddItem(new MenuItem("BladeEnemyhp", "敌人最小血量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("items")
                    .SubMenu("Offensive")
                    .AddItem(new MenuItem("Blademyhp", "自己最大血量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("items").AddSubMenu(new Menu("防御物品", "Deffensive"));
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
                    .AddItem(new MenuItem("Omen", "使用 兰頓"))
                    .SetValue(true);
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
                    .AddItem(new MenuItem("Omenenemys", "兰盾|敌方人数").SetValue(new Slider(2, 1, 5)));
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
               ...
               _config.SubMenu("items")
                    .SubMenu("Deffensive")
                    .AddItem(new MenuItem("lotisminhp", "鸟盾|队友血量").SetValue(new Slider(35, 1, 100)));
                ...
                _config.SubMenu("Farm")
                    .SubMenu("LaneFarm")
                    .AddItem(new MenuItem("Energylane", "清线|最低能量").SetValue(new Slider(45, 1, 100)));
                _config.SubMenu("Farm")
                    .SubMenu("LaneFarm")
                    .AddItem(
                ...
                _config.SubMenu("Farm")
                    .SubMenu("LastHit")
                    .AddItem(new MenuItem("Energylast", "补刀|最低能量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("Farm")
                    .SubMenu("LastHit")
                    .AddItem(
                ...
                _config.SubMenu("Farm")
                    .SubMenu("Jungle")
                    .AddItem(new MenuItem("Energyjungle", "清野|最低能量").SetValue(new Slider(85, 1, 100)));
                _config.SubMenu("Farm")
                    .SubMenu("Jungle")
                    .AddItem(
                ...
                _config.SubMenu("Misc").AddItem(new MenuItem("rdodge", "自动R躲避危险技能")).SetValue(true);
                ...
                _config.SubMenu("Drawings").AddItem(new MenuItem("DrawQW", "范围 远程 骚扰")).SetValue(true);
                ...
                _config.SubMenu("Drawings").AddItem(new MenuItem("damagetest", "显示 伤害 信息")).SetValue(true);
                _config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "延迟 自由圈").SetValue(true));
                _config.SubMenu("Drawings")
                    .AddItem(new MenuItem("CircleQuality", "线圈|薄厚").SetValue(new Slider(100, 100, 10)));
                _config.SubMenu("Drawings")
                    .AddItem(new MenuItem("CircleThickness", "线圈|质量").SetValue(new Slider(1, 10, 1)));
                _config.AddToMainMenu();
                Game.PrintChat("<font color='#881df2'>鍔珅 by Diabaths & jackisback</font>鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847.");
                Game.PrintChat("<font color='#f2881d'>鎹愯禒浣滆€卲aypal= bulut@live.co.uk</font>");
