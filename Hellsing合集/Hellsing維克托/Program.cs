...
namespace Viktor
{
    public class Program
    {
        ...
        {
            menu = new MenuWrapper("[Hellsing] " + "维克托");
            ...
            ProcessLink("comboExtend", subMenu.AddLinkedKeyBind("E 延伸 距离", 'A', KeyBindType.Press));

            // Harass
            subMenu = menu.MainMenu.AddSubMenu("骚 扰");
            ProcessLink("harassUseE", subMenu.AddLinkedBool("使用 E"));
            ProcessLink("harassMana", subMenu.AddLinkedSlider("骚扰 最低蓝量 (%)", 30));
            ...
            ProcessLink("waveNumE", subMenu.AddLinkedSlider("E 清小兵数", 2, 1, 10));
            ...
            // Misc
            subMenu = menu.MainMenu.AddSubMenu("杂 项");
            ProcessLink("miscInterrupt", subMenu.AddLinkedBool("使用 R 打断危险的法术"));
            ProcessLink("miscGapcloser", subMenu.AddLinkedBool("使用 W 阻止 突进"));

            // Drawings
            subMenu = menu.MainMenu.AddSubMenu("范 围");
            ProcessLink("drawRangeQ", subMenu.AddLinkedCircle("Q 范围", true, Color.FromArgb(150, Color.IndianRed), Q.Range));
            ProcessLink("drawRangeW", subMenu.AddLinkedCircle("W 范围", true, Color.FromArgb(150, Color.IndianRed), W.Range));
            ProcessLink("drawRangeE", subMenu.AddLinkedCircle("E 范围", false, Color.FromArgb(150, Color.DarkRed), E.Range));
            ProcessLink("drawRangeEMax", subMenu.AddLinkedCircle("E 最大 范围", true, Color.FromArgb(150, Color.OrangeRed), maxRangeE));
            ProcessLink("drawRangeR", subMenu.AddLinkedCircle("R 范围", false, Color.FromArgb(150, Color.Red), R.Range));
        }
    }
}
