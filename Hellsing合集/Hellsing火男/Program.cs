...
namespace Brand
{
    public static class Program
    {
        ...
        private static void SetuptMenu()
        {
            ...
            // Combo
            var combo = menu.MainMenu.AddSubMenu("连 招");
            ...
            keyLinks.Add("comboActive", combo.AddLinkedKeyBind("启用 连招", 32, KeyBindType.Press));

            // Harass
            var harass = menu.MainMenu.AddSubMenu("骚 扰");
            boolLinks.Add("harassUseQ", harass.AddLinkedBool("使用 Q"));
            boolLinks.Add("harassUseW", harass.AddLinkedBool("使用 W"));
            keyLinks.Add("harassToggleW", harass.AddLinkedKeyBind("使用 W (切换)", 'T', KeyBindType.Toggle));
            boolLinks.Add("harassUseE", harass.AddLinkedBool("使用 E"));
            keyLinks.Add("harassActive", harass.AddLinkedKeyBind("启用 骚扰", 'C', KeyBindType.Press));

            // Wave clear
            var waveClear = menu.MainMenu.AddSubMenu("清 线");
            boolLinks.Add("waveUseQ", waveClear.AddLinkedBool("使用 Q"));
            boolLinks.Add("waveUseW", waveClear.AddLinkedBool("使用 W"));
            sliderLinks.Add("waveNumW", waveClear.AddLinkedSlider("对多少小兵 使用w", 3, 1, 10));
            boolLinks.Add("waveUseE", waveClear.AddLinkedBool("使用 E"));
            keyLinks.Add("waveActive", waveClear.AddLinkedKeyBind("启用 清线", 'V', KeyBindType.Press));

            // Drawings
            var drawings = menu.MainMenu.AddSubMenu("范 围");
            ...
            circleLinks.Add("drawRangeE", drawings.AddLinkedCircle("E 范围", false, Color.FromArgb(150, Color.DarkRed), E.Range));
