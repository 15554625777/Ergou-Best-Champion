...
namespace BlackZilean
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            // Print
            Game.PrintChat(
                String.Format("Black鏃跺厜涓ㄥ姞杞芥垚鍔燂紒姹夊寲by Bbyyyy锛丵Q缇や辅361630847",
                    ChampName));
        }
        ...
        private static void CreateMenu()
        {
            ...
            // Ult
            var ult = new Menu("大", "ult");
            Menu.AddSubMenu(ult);
            ult.AddItem(new MenuItem("ultUseR", "使用 R 到")).SetValue(true);
            ...
            ult.AddItem(new MenuItem("ultPercent", "R HP %")).SetValue(new Slider(25, 1));
            ...
            misc.AddItem(
                new MenuItem("miscEscapeToMouse", "向鼠标方向逃跑").SetValue(new KeyBind('G', KeyBindType.Press)));
            misc.AddItem(new MenuItem("miscUseE", "使用 E 逃跑").SetValue(true));
