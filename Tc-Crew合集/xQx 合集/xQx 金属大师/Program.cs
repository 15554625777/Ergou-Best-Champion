    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActiveT", "使用 (自动)!").SetValue(new KeyBind("H".ToCharArray()[0],
                        KeyBindType.Toggle)));
            Config.SubMenu("Harass")
                .AddItem(
            ...
            MenuExtras.AddItem(new MenuItem("ShieldSelf", "盾 自己").SetValue(true));
            MenuExtras.AddItem(new MenuItem("ShieldAlly", "盾 队友").SetValue(false));
            Config.AddSubMenu(MenuExtras);

            /* [ Drawing ] */
            Config.AddSubMenu(new Menu("范围", "Drawings"));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawW", "W 有效 范围").SetValue(new Circle(true, Color.Pink)));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawWAffectedRange", "W 影响 范围").SetValue(new Circle(true, Color.Pink)));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawAloneEnemy", "Q 孤立 目标").SetValue(new Circle(true, Color.Pink)));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawSlavePos", "大招 灵魂 位置.").SetValue(new Circle(true, Color.Pink)));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawSlaveRange", "大招 灵魂 范围").SetValue(new Circle(true, Color.Pink)));

            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEmpty", ""));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawDisable", "禁止 全部").SetValue(false));
            Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEmpty", ""));
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (MordekaiserHaveSlave)
            {
                ...
                {
                 //   Game.PrintChat("xQx 閲戝睘澶у笀涓ㄥ姞杞芥垚鍔燂紒姹夊寲by Bbyyyyy锛丵Q缇や辅361630847");
