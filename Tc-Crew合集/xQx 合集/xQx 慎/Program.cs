...
namespace Shen
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("xQx | 慎", "Shen", true);
            ...
            {
                /* [ Don't Use Ult ] */
                Config.SubMenu("Combo").AddSubMenu(new Menu("禁止 使用 R 到", "DontUlt"));
                ...
                /* [ Ult Priority ] */
                Config.SubMenu("Combo").AddSubMenu(new Menu("优先 大招", "UltPriority"));
                foreach (var ally in ObjectManager.Get<Obj_AI_Hero>().Where(ally => ally.IsAlly && !ally.IsMe))
                ...
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboUseEF", "使用 闪现 + E").SetValue(new KeyBind("T".ToCharArray()[0],KeyBindType.Press)));
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboUseRE", "使用 R | 时刻").SetValue(true));
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboUseRK", "使用 R | 确认 这个 关键:").SetValue(new KeyBind("U".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.AddSubMenu(new Menu("骚扰", "Harass"));
            {
                ...
                Config.SubMenu("Harass").AddItem(new MenuItem("HarassEnergy", "骚扰最低能量: ").SetValue(new Slider(50, 100, 0)));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearEnergy", "清线最低能量: ").SetValue(new Slider(50, 100, 0)));
            ...
            Config.AddSubMenu(new Menu("清野", "JungleFarm"));
            {
                ...
                Config.SubMenu("JungleFarm").AddItem(new MenuItem("JungleFarmEnergy", "清野最低能量: ").SetValue(new Slider(50, 100, 0)));
            ...
            Config.AddSubMenu(new Menu("范围", "Drawings"));
            {
                ...
                Config.SubMenu("Drawings").AddItem(new MenuItem("DrawRswnp", "显示需要帮助的人").SetValue(true));
            }
            ...
            Config.AddSubMenu(new Menu("Speech", "Speech"));
            {
                ...
                Config.SubMenu("Speech").AddItem(new MenuItem("SpeechVolume", "Volume").SetValue(new Slider(50, 10, 100)));//.ValueChanged += (sender, eventArgs) => { Game.PrintChat("xQx 鎱庝辅鍔犺浇鎴愬姛锛佹眽鍖朾y Bbyyyyy锛丵Q缇や辅361630847"); };
        ...
        public static void Speech()
        {
            ...
            {
                Game.PrintChat("xQx 鎱庝辅鍔犺浇鎴愬姛锛佹眽鍖朾y Bbyyyyy锛丵Q缇や辅361630847");
            }
