...
namespace Swain
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseDFGCombo", "使用 冥火").SetValue(true));
            ...
            Game.PrintChat(String.Format("xQx 涔岄甫涓ㄦ垚鍔熷姞杞斤紒姹夊寲by Bbyyyyy锛丵Q缇や辅361630847", ChampionName));
        }
