...
namespace EasyAhri
{
    class EasyAhri : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_e", "使用 E").SetValue(true));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_q", "Q 范 围").SetValue(new Circle(true, Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_w", "W 范 围").SetValue(new Circle(true, Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_e", "E 范 围").SetValue(new Circle(true, Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_r", "R 范 围").SetValue(new Circle(true, Color.FromArgb(100, 0, 255, 0))));
