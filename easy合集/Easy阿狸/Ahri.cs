...
public class Ahri : Champion
{
	...
	protected override void OnInitMenu()
	{
        ...
        BoolLinks.Add("auto_e_slows", autoMenu.AddLinkedBool("使用 E （对面 减速）", true));
        BoolLinks.Add("auto_e_stuns", autoMenu.AddLinkedBool("使用 E （对方被眩晕）", true));
        BoolLinks.Add("auto_e_gapclosers", autoMenu.AddLinkedBool("使用 E （阻止突进）", true));
        SliderLinks.Add("auto_mana", autoMenu.AddLinkedSlider("保持 蓝量", 200, 0, 500));

        MenuWrapper.SubMenu drawingMenu = Menu.MainMenu.AddSubMenu("范 围");
        BoolLinks.Add("drawing_q", drawingMenu.AddLinkedBool("Q 范 围", true));
        BoolLinks.Add("drawing_w", drawingMenu.AddLinkedBool("W 范 围", true));
        BoolLinks.Add("drawing_e", drawingMenu.AddLinkedBool("E 范 围", true));
        BoolLinks.Add("drawing_r", drawingMenu.AddLinkedBool("R 范 围", true));
        BoolLinks.Add("drawing_damage", drawingMenu.AddLinkedBool("显示 连招 伤害", true));

        MenuWrapper.SubMenu miscMenu = Menu.MainMenu.AddSubMenu("杂 项");
        KeyLinks.Add("misc_charm", miscMenu.AddLinkedKeyBind("使用 魅惑 按键", 'T', KeyBindType.Press));
	}
