...
namespace D_Corki
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Corki
            _config = new Menu("D-飞机", "D-Corki", true);
            ...
            _config.SubMenu("Combo").AddSubMenu(new Menu("W 设置", "Use W"));
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "血量低于丨使用补给").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "蓝量低于丨使用补给").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("RlimH", "使用R丨最大人数").SetValue(new Slider(3, 1, 7)));
            ...
            //Farm
            _config.AddSubMenu(new Menu("清线丨打野", "Farm"));
