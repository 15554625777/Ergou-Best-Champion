...
namespace Support.Plugins
{
    ...
    public class Braum : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.R.Count", "對多少敵人使用 R", 2, 1, 5);
        }
        ...
        {
            config.AddBool("Misc.Shield.Skill", "使用堅韌不催 抵擋", true);
            config.AddBool("Misc.Shield.Target", "使用堅韌不催 目標", true);
            config.AddSlider("Misc.Shield.Health", "使用堅韌不催抵擋平A 最低HP", 30, 1, 100);
        }
