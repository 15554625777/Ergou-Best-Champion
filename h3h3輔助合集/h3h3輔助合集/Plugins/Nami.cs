...
namespace Support.Plugins
{
    ...
    public class Nami : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("ComboCountR", "敵人在範圍內", 2, 1, 5);
            config.AddSlider("ComboHealthW", "W 補血", 20, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("HarassHealthW", "騷擾 W補血", 20, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            var sub = config.AddSubMenu(new Menu("進攻時 使用 E", "Misc.E.AA.Menu"));
        ...
        {
            config.AddBool("GapcloserQ", "使用 Q 阻止 突進", true);
