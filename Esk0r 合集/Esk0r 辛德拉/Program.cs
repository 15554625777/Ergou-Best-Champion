...
namespace Syndra
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseIgniteCombo", "使用 引燃").SetValue(true));
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActiveT", "骚扰 (开/关)!").SetValue(new KeyBind("Y".ToCharArray()[0],
                        KeyBindType.Toggle)));
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseQFarm", "使用 Q").SetValue(
                        new StringList(new[] { "禁止", "清线", "二者之间", "不用" }, 2)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseWFarm", "使用 W").SetValue(
                       new StringList(new[] { "禁止", "清线", "二者之间", "不用" }, 1)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseEFarm", "使用 E").SetValue(
                        new StringList(new[] { "禁止", "清线", "二者之间", "不用" }, 3)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("FreezeActive", "禁止!").SetValue(
                        new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            //JungleFarm menu:
            Config.AddSubMenu(new Menu("清理野怪", "JungleFarm"));
            ...
            Config.SubMenu("JungleFarm")
                .AddItem(
                    new MenuItem("JungleFarmActive", "清理野怪!").SetValue(
                        new KeyBind(Config.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));

            //Misc
            Config.AddSubMenu(new Menu("杂项", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("InterruptSpells", "打断 技能").SetValue(true));
            Config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("CastQE", "QE 最近的指针").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));
            Config.SubMenu("Misc").AddSubMenu(new Menu("不使用 R ", "DontUlt"));
            ...
            //Damage after combo:
            var dmgAfterComboItem =  new MenuItem("DamageAfterCombo", "连招后显示伤害").SetValue(true);
            ...
            Game.PrintChat(ChampionName + " 鍔犺級鎴愬姛锛佹饥鍖朾y楝肩伒锛丵Q缇361630847!");
        }
