...
namespace Velkoz
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("虚空之眼", "Velkoz", true);
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("InterruptSpells", "中断 技能").SetValue(true));
            Config.SubMenu("Misc").AddSubMenu(new Menu("禁用 R", "DontUlt"));
