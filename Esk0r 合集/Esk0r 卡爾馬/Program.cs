...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config.AddSubMenu(new Menu("額外選項", "Misc"));
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEDefense", "使用E主動防禦").SetValue(true));

            _config.AddSubMenu(new Menu("顯示範圍", "Drawings"));
            _config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("QRange", "Q 範圍").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));
            _config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("WRange", "W 範圍").SetValue(new Circle(false, Color.FromArgb(255, 255, 255, 255))));
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("WRootRange", "W 根本 範圍").SetValue(new Circle(true, Color.MintCream)));
