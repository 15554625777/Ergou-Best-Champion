...
namespace ChewyMoonsShaco
{
    internal class ChewyMoonShaco
    {
        ...
        public static void OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color=\"#6699ff\"><b>ChewyMoon's 钀ㄧ:</b></font> <font color=\"#FFFFFF\">" +
        ...
        {
            (Menu = new Menu("[Chewy's 萨科]", "cmShaco", true)).AddToMainMenu();
            ...
            comboMenu.AddItem(new MenuItem("useItems", "使用 物品").SetValue(true));
