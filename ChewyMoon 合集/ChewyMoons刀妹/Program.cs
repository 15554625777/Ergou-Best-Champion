...
namespace ChewyMoonsIrelia
{
    internal class Program
    {
        ...
        {
            _menu = new Menu("ChewyMoon's 刀妹", "cmIrelia", true);

            // Target Selector
            var targetSelectorMenu = new Menu("目標選擇r", "cmIreliaTS");
            ...
            // Lasthiting
            var farmingMenu = new Menu("清线", "cmIreliaFarming");
            ...
            // Wave clear submenu
            var waveClearMenu = new Menu("清线", "cmIreliaFarmingWaveClear");
            ...
            //Drawing menu
            var drawingMenu = new Menu("范围", "cmIreliaDraw");
            ...
            drawingMenu.AddItem(new MenuItem("drawStunnable", "顯示 Stunnable").SetValue(true));
            ...
            _menu.AddItem(new MenuItem("comboActive", "启用 连招").SetValue(new KeyBind(32, KeyBindType.Press)));
