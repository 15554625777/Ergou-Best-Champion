...
namespace D_Jarvan
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Jarvan
            _config = new Menu("D-皇子", "D-Jarvan", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("smitecombo", "对目标使用承接")).SetValue(true);
            ...
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("MinTargets", "使用R丨敌人最低数量").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("ActiveCombo", "连招!").SetValue(new KeyBind(32, KeyBindType.Press)));
            _config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ActiveComboEQR", "使用EQ-R!").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboeqFlash", "使用EQ- 闪现!").SetValue(new KeyBind("H".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Combo")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "使用红药丨自己血量").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "使用蓝药丨自己血量").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(new MenuItem("UseWLHHP", "使用 W 丨血量大于").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("UseIgnitekill", "使用引燃击杀")).SetValue(true);
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_W", "W 防止突击")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEQInt", "EQ 打断技能")).SetValue(true);
            // _config.SubMenu("Misc").AddItem(new MenuItem("MinTargetsgap", "min enemy >=(GapClosers)").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinjar", "使用 换肤（已失效）").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinjarvan", "皮肤选择").SetValue(new Slider(4, 1, 7)));
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("Drawsmite", "显示惩戒范围")).SetValue(true);
