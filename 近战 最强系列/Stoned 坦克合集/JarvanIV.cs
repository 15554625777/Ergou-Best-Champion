...
namespace StonedSeriesAIO
{
    internal class JarvanIV
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("Stoned 王子", "StonedJarvan", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEQCombo", "使用 EQ")).SetValue(true);
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("EQmouse", "EQ 鼠标 方向").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Misc").AddItem(new MenuItem("Ignite", "使用 点燃").SetValue(true));
