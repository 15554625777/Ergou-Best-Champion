...
namespace BlackPoppy
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            // Print
            Game.PrintChat(
                String.Format("<font color='#08F5F8'>black娉㈡瘮 -</font> <font color='#FFFFFF'>{0} 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847!</font>",
                    ChampName));
        }
        ...
        {
            Menu = new Menu("Black 波比", "black" + ChampName, true);

            // Target selector
            var ts = new Menu("目标选择", "ts");
            Menu.AddSubMenu(ts);
            ...
            combo.AddItem(new MenuItem("comboLogicR", "使用大招|范围内目标").SetValue(new Slider(2, 1, 5)));
            combo.AddItem(new MenuItem("comboActive", "连招 键位!").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            harass.AddItem(new MenuItem("harassActive", "骚扰 键位!").SetValue(new KeyBind('C', KeyBindType.Press)));
            ...
            waveclear.AddItem(new MenuItem("wcActive", "清线 键位!").SetValue(new KeyBind('V', KeyBindType.Press)));
            ...
            misc.AddItem(
                new MenuItem("miscEscapeToMouse", "逃跑").SetValue(new KeyBind('G', KeyBindType.Press)));
            misc.AddItem(new MenuItem("miscUseW", "使用W向鼠标方向逃跑").SetValue(true));
            misc.AddItem(new MenuItem("DontUlt", "禁用R"));
            ...
            //Damage after combo:
            var dmgAfterComboItem = new MenuItem("DamageAfterCombo", "显示组合伤害连招").SetValue(true);
