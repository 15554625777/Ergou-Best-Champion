...
namespace FuckingAwesomeRiven
{
    class MenuHandler
    {
        ...
        public static void initMenu()
        {
            ...
            misc.AddItem(new MenuItem("bonusCancelDelay", "取消 延迟 (毫秒)").SetValue(new Slider(0,0,500)));
            ...
            Config.AddItem(new MenuItem("Mgdgdfgsd", "版本: 0.0.3 Test"));
            Config.AddItem(new MenuItem("Msd", "作者 By FluxySenpai"));
            Config.AddItem(new MenuItem("messgane", "花边汉化-FA瑞文!"));
			            Config.AddItem(new MenuItem("shuoming", "L#是免费项目"));
						            Config.AddItem(new MenuItem("M1sd", "而且脚本是免费的"));
									            Config.AddItem(new MenuItem("M1s1d", "卖卖卖 卖你麻痹啊,贱人"));
