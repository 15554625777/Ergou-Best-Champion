    ...
    class Program
    {
       ...
       private static readonly int[] SmiteBlue = { 3706, 3710, 3709, 3708, 3707 };
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("蜘蛛女皇", "D-Elise", true);
            ...
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("ActiveHarass", "骚扰 按键").SetValue(new KeyBind("C".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Bilgemyhp", "使用小弯刀|血量").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "使用补给|自己血量").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "使用补给|自己篮量").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("Ks").AddItem(new MenuItem("UseIgnite", "使用 引燃")).SetValue(true);
