...
namespace D_Corki
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Corki
            _config = new Menu("D-库奇", "D-Corki", true);
            ...
            _config.SubMenu("Combo").AddSubMenu(new Menu("W设置", "UseW"));
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("UseWC", "使用 W")).SetValue(true);
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("diveintower", "允许W进塔下")).SetValue(true);
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("UseWHE", "使用W|你的血量").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("EnemyC", "使用W|敌人在R范围数量 <").SetValue(new Slider(2, 1, 5)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("RlimH", "使用R最大人数").SetValue(new Slider(3, 1, 7)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "骚扰（自动）").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "骚扰").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("UseELH", "E 补刀")).SetValue(true);
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("RlimL", "R 库存 >").SetValue(new Slider(3, 1, 7)));
            _config.SubMenu("Farm").AddItem(new MenuItem("Lanemana", "清兵|清野最低蓝量").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ActiveLast", "补刀!").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ActiveLane", "清线/清野!").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("skinC", "使用 换肤功能").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinCorki", "选择皮肤").SetValue(new Slider(4, 1, 7)));
            ...
            Game.PrintChat("<font color='#881df2'>D-搴 鍔犺級鎴愬姛锛佹饥鍖朾y楝肩伒锛丵Q缇361630847.");
            Game.PrintChat(
