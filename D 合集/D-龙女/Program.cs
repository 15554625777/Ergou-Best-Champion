...
namespace D_Shyvana
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Shyvana
            _config = new Menu("D-龙女", "D-Shyvana", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("smitecombo", "使用 惩戒 击杀目标")).SetValue(true);
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "使用红药丨自己血量").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "使用蓝药丨自己血量").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseWLH", "W 补刀")).SetValue(true);
            ...
            _config.SubMenu("Farm")
                ...
                .SetValue(true);
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("UseQL", "Q 清线")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("UseWL", "W 清线")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("UseEL", "E 清线")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("LaneClear")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddSubMenu(new Menu("JungleClear", "清野"));
            _config.SubMenu("Farm")
                .SubMenu("LaneClear")
                .AddItem(new MenuItem("UseItemsjungle", "使用 物品 清野"))
                .SetValue(true);
            ...
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "提前惩戒红BUFFF|血量低于").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("skinshy", "使用皮肤功能").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinshyvana", "选择皮肤").SetValue(new Slider(4, 1, 6)));
           // _config.SubMenu("Misc").AddItem(new MenuItem("usePackets", "Usepackes")).SetValue(true);
            ...
            _config.SubMenu("HitChance")
                .AddItem(new MenuItem("Echange", "E 命中率").SetValue(
                    new StringList(new[] { "低", "中", "高", "极高" })));
            _config.SubMenu("HitChance")
                .AddItem(new MenuItem("Rchange", "R 命中率").SetValue(
                    new StringList(new[] {"低", "中", "高", "极高"})));
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("Drawsmite", "惩戒 范围")).SetValue(true);
            ...
            Game.PrintChat("<font color='#881df2'>D-鐜嬪瓙 by Diabaths</font> 鍔犺浇鎴愬姛!姹夊寲by楝肩伒!QQ缇361630847.");
