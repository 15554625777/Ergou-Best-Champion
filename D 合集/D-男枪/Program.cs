...
namespace D_Graves
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //LaneClear
            _config.AddSubMenu(new Menu("清野丨清线", "Farm"));
            ...
            _config.AddSubMenu(new Menu("杂项", "items"));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_E", "自动W突脸")).SetValue(true);
            ...
            _config.SubMenu("HitChance")
                .SubMenu("KillSteal")
                .AddItem(
                    new MenuItem("Wchangekill", "W 命中率").SetValue(
                       new StringList(new[] { "低", "中", "高", "很高" })));
            _config.SubMenu("HitChance")
                .SubMenu("KillSteal")
                .AddItem(
                    new MenuItem("Rchangekill", "R 命中率").SetValue(
                        new StringList(new[] { "低", "中", "高", "很高" })));
