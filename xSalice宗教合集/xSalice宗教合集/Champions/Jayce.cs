    ...
    class Jayce : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Keys"); { 
                key.AddItem(new MenuItem("ComboActive", "连招!").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActive", "骚扰!").SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActiveT", "骚扰 (自动)!").SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("shootMouse", "EQ鼠标方向").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }

            //Combo menu:
            var combo = new Menu("连招", "Combo"); { 
                combo.AddItem(new MenuItem("UseQCombo", "使用 炮形态 Q").SetValue(true));
                combo.AddItem(new MenuItem("qSpeed", "QE 速度, 调高=更快, 调低=精准").SetValue(new Slider(1600, 400, 2500)));
                combo.AddItem(new MenuItem("UseWCombo", "使用 炮形态 W").SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用 炮形态 E").SetValue(true));
                combo.AddItem(new MenuItem("UseQComboHam", "使用 Hammer Q").SetValue(true));
                combo.AddItem(new MenuItem("UseWComboHam", "使用 Hammer W").SetValue(true));
                combo.AddItem(new MenuItem("UseEComboHam", "使用 Hammer E").SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用 R to Switch").SetValue(true));
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("UseQHarassHam", "使用 Q Hammer").SetValue(true));
                harass.AddItem(new MenuItem("UseWHarassHam", "使用 W Hammer").SetValue(true));
                harass.AddItem(new MenuItem("UseEHarassHam", "使用 E Hammer").SetValue(true));
                harass.AddItem(new MenuItem("UseRHarass", "使用 R to switch").SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc"); { 
                misc.AddItem(new MenuItem("UseInt", "使用 E to Interrupt").SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 E for GapCloser").SetValue(true));
                ...
                misc.AddItem(new MenuItem("UseQAlways", "使用 Q When E onCD").SetValue(true));
            ...
            var drawMenu = new Menu("范围", "Drawings"); {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q", "显示 Q Cannon").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_QExtend", "Draw Q Cannon Extended").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E", "显示 E Cannon").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_Q2", "显示 Q Hammer").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "显示 E Hammer").SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "显示 技能冷却")).SetValue(true);
