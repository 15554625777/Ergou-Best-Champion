    ...
    class Azir : Champion
    {
        ...
        private void LoadMenu()
        {
             ...
             var key = new Menu("键位", "Key");
            {
                ...
                key.AddItem(new MenuItem("escape", "逃跑").SetValue(new KeyBind(menu.Item("Flee_Key").GetValue<KeyBind>().Key, KeyBindType.Press)));
                key.AddItem(new MenuItem("insec", "R 目标选择").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("qeCombo", "Q->E 突进目标").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }

            //Spell Menu
            var spell = new Menu("法术 菜单", "Spell");
            {

                var qMenu = new Menu("Q 法术", "QSpell"); { 
                    qMenu.AddItem(new MenuItem("qOutRange", "使用Q|敌人走出沙兵攻击范围").SetValue(false));
                    qMenu.AddItem(new MenuItem("qExtend", "延伸 Q 范围").SetValue(true));
                    qMenu.AddItem(new MenuItem("qMulti", "使用Q|可击中两个以上目标").SetValue(true));
                    qMenu.AddItem(new MenuItem("qHit", "Q 命中率").SetValue(new Slider(3, 1, 3)));
                    spell.AddSubMenu(qMenu);
                }
                //W Menu
                var wMenu = new Menu("W 法术", "WSpell"); {
                    wMenu.AddItem(new MenuItem("wAtk", "自动攻击敌人").SetValue(true));
                    wMenu.AddItem(new MenuItem("wQ", "使用 WQ Poke").SetValue(true));
                    spell.AddSubMenu(wMenu);
                }
                //E Menu
                var eMenu =  new Menu("E 法术", "ESpell");
                {
                    eMenu.AddItem(new MenuItem("eGap", "突进|敌人走出Q范围").SetValue(false));
                    eMenu.AddItem(new MenuItem("eKill", "可击杀使用E").SetValue(false));
                    eMenu.AddItem(new MenuItem("eKnock", "总是击飞敌人").SetValue(false));
                    eMenu.AddItem(new MenuItem("eHP", "使用E|血量大于").SetValue(new Slider(100)));
                    spell.AddSubMenu(eMenu);
                }
                //R Menu
                var rMenu = new Menu("R 法术", "RSpell");{
                    rMenu.AddItem(new MenuItem("rHP", "使用R|血量低于").SetValue(new Slider(20)));
                    rMenu.AddItem(new MenuItem("rHit", "使用R|敌人数量").SetValue(new Slider(3, 0, 5)));
                    rMenu.AddItem(new MenuItem("rWall", "将敌人R进墙内").SetValue(true));
            ...
            {
                killSteal.AddItem(new MenuItem("smartKS", "使用 智能抢人头").SetValue(true));
                killSteal.AddItem(new MenuItem("eKS", "使用 E KS").SetValue(false));
                killSteal.AddItem(new MenuItem("wqKS", "使用 WQ KS").SetValue(true));
                killSteal.AddItem(new MenuItem("qeKS", "使用 WQE KS").SetValue(false));
                killSteal.AddItem(new MenuItem("rKS", "使用 R KS").SetValue(true));
            ...
            var farm = new Menu("清兵", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("qFarm", "使用Q|小兵数量").SetValue(new Slider(3, 0, 5)));
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("fastEscape", "逃避 模式 2").SetValue(true));
            ...
            var draw = new Menu("范围", "Drawings"); { 
                ...
                draw.AddItem(new MenuItem("QExtendRange", "Q 延伸 范围").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                ...
                draw.AddItem(new MenuItem("RRange", "R 范围").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                draw.AddItem(new MenuItem("slaveDmg", "显示 沙兵 攻击范围").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
