    ...
    class Reksai : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("UseQCombo", "使用 Q（同时）").SetValue(true));
                combo.AddItem(new MenuItem("Q_Reset", "Q 自动攻击 ").SetValue(true));
                combo.AddItem(new MenuItem("UseWCombo", "使用 W").SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用 遁地 E").SetValue(true));
                combo.AddItem(new MenuItem("Ignite", "使用 点燃").SetValue(true));
                combo.AddItem(new MenuItem("Use_Item", "使用 物品").SetValue(true));
                //add to menu
            ...
            var drawMenu = new Menu("范围", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q", "显示 Q").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E", "显示 E").SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_CD", "显示 遁地 CD").SetValue(true));
