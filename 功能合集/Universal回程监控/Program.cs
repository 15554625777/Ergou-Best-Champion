...
namespace UniversalRecallTracker
{
    public class Program
    {
        ...
        {
            get { return _showOnStart.GetValue<bool>(); }
        }
        ...
        {
            Menu menu = new Menu("回程监控", "universalrecalltracker", true);
            _x =
            ...
            _textSize = new MenuItem("textSize", "文本 大小 (F5 重载)").SetValue(new Slider(15, 5, 50));
            _chatWarning = new MenuItem("chatWarning", "聊天栏 提醒").SetValue(false);
            _showOnStart = new MenuItem("showOnStart", "启用 显示").SetValue(true);
        ...
        public void Print(string msg, bool timer = false)
        {
            ...
            s +=
                "<font color='#ff3232'>Universal</font><font color='#d4d4d4'>鍥炵▼鐩戞帶:鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍  浜岀嫍QQ缇361630847</font> <font color='#FFFFFF'>" +
                msg + "</font>";
            Game.PrintChat(s);
        }
