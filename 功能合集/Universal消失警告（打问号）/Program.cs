...
namespace UniversalPings
{
    internal class Program
    {
        ...
        {
            _menu = new Menu("消失警告", "UniversalPings", true);
            _menu.AddItem(new MenuItem("print", "显示").SetValue(new StringList(new[] { "冠军英雄", "英雄", "同时" })));
            _menu.AddItem(new MenuItem("block", "[免打扰设置]"));
        ...
        {
            Game.PrintChat(
                "<font color='#ff3232'>Universal</font><font color='#d4d4d4'>娑堝け璀﹀憡:鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍  浜岀嫍QQ缇361630847</font> <font color='#FFFFFF'>" + msg +
                "</font>");
        }
    }
