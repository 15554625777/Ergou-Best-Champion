...
namespace ViktorTheMindBlower
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("机械先驱-维克托", "Viktor", true);
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("LaneClearActive", "清线!").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            ...
            //Q Menu
            menu.SubMenu("Spell").AddSubMenu(new Menu("Q 法术", "QSpell"));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("QAARange", "Q只在平A范围内用").SetValue(true));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("autoAtk", "Q后自动A").SetValue(true));
            //W Menu
            menu.SubMenu("Spell").AddSubMenu(new Menu("W 法术", "WSpell"));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wSlow", "自动 W 减速").SetValue(true));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wImmobile", "自动 W 固定的敌人").SetValue(true));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wDashing", "自动 W 移动的敌人").SetValue(true));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("useW_Hit", "自动 W |敌人数量").SetValue(new Slider(2, 1, 5)));
            //R
            menu.SubMenu("Spell").AddSubMenu(new Menu("R 法术", "RSpell"));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("useR_Hit", "自动 R |敌人数量").SetValue(new Slider(2, 1, 5)));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("selected", "攻击 选定目标").SetValue(true));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("eHit", "E 命中敌人").SetValue(new Slider(3, 1, 4)));
            ...
            menu.SubMenu("Combo")
                .AddItem(new MenuItem("igniteMode", "点燃 模式").SetValue(new StringList(new[] { "连招", "抢人头" }, 0)));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("eHit2", "E 命中敌人").SetValue(new Slider(4, 1, 4)));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "使用 技能封包").SetValue(true));
