    ...
    class Katarina : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按 键", "Key");{
                ...
                key.AddItem(new MenuItem("LaneClearActive", "清线 按键!", true).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("jFarm", "清野 按键", true).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("lastHit", "补刀 按键!", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("Wardjump", "逃跑/摸眼 逃生", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连 招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("eDis", "使用 E丨距离 >", true).SetValue(new Slider(0, 0, 700)));
                combo.AddItem(new MenuItem("smartE", "R在CD丨智能E", true).SetValue(false));
            ...
            //Farming menu:
            var farm = new Menu("打 钱", "Farm");
            {
                farm.AddItem(new MenuItem("UseQFarm", "使用 Q 清线", true).SetValue(false));
                farm.AddItem(new MenuItem("UseWFarm", "使用 W 清线", true).SetValue(false));
                farm.AddItem(new MenuItem("UseEFarm", "使用 E 清线", true).SetValue(false));
            ...
            {
                killSteal.AddItem(new MenuItem("smartKS", "使用 智能击杀系统", true).SetValue(true));
                killSteal.AddItem(new MenuItem("wardKs", "使用 摸眼 击杀", true).SetValue(true));
                killSteal.AddItem(new MenuItem("rKS", "使用 R 击杀", true).SetValue(true));
                killSteal.AddItem(new MenuItem("dfgKS", "使用 冥火 击杀", true).SetValue(true));
                killSteal.AddItem(new MenuItem("rCancel", "R在CD丨禁止击杀", true).SetValue(false));
                killSteal.AddItem(new MenuItem("KS_With_E", "禁止使用E 抢人头!", true).SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle)));
                //add to menu
            ...
            {
                misc.AddItem(new MenuItem("autoWz", "自动 W 骚扰", true).SetValue(true));
