...
namespace xSaliceReligionAIO
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            var menuDrawing = new Menu("范围 显示", "orb_Draw");
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange", "AA 范围").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange_Enemy", "敌人 平A 范围").SetValue(new Circle(true, Color.Pink)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Holdzone", "控制 范围").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar", "小兵 血条").SetValue(new Circle(true, Color.Black)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar_thickness", "^ 血条 厚度").SetValue(new Slider(1, 1, 3)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_hitbox", "显示 打击").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Lasthit", "显示 补刀状态").SetValue(new Circle(true, Color.Lime)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_nearKill", "附近可击杀 小兵").SetValue(new Circle(true, Color.Gold)));
            menu.AddSubMenu(menuDrawing);

            var menuMisc = new Menu("杂项 设置", "orb_Misc");
            menuMisc.AddItem(new MenuItem("orb_Misc_Holdzone", "控制 区域").SetValue(new Slider(50, 0, 200)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Farmdelay", "打钱 延迟").SetValue(new Slider(0, 0, 300)));
            if(MyHero.ChampionName == "Azir")
                menuMisc.AddItem(new MenuItem("azir_Misc_Farmdelay", "清兵 延迟").SetValue(new Slider(0, 0, 300)));
            menuMisc.AddItem(new MenuItem("orb_Misc_ExtraWindUp", "额外 结束时间").SetValue(new Slider(80, 200, 0)));
            menuMisc.AddItem(new MenuItem("orb_Misc_AutoWindUp", "自动设置 结束时间").SetValue(new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Priority_Unit", "优先 设置").SetValue(new StringList(new[] { "小兵", "英雄" })));
            menuMisc.AddItem(new MenuItem("orb_Misc_Humanizer", "移动 延迟").SetValue(new Slider(50, 0, 500)));
            menuMisc.AddItem(new MenuItem("orb_Misc_AllMovementDisabled", "禁止 所有 移动").SetValue(false));
            menuMisc.AddItem(new MenuItem("orb_Misc_AllAttackDisabled", "禁止 所有 攻击").SetValue(false));

            menu.AddSubMenu(menuMisc);

            var menuMelee = new Menu("混 战", "orb_Melee");
            menuMelee.AddItem(new MenuItem("orb_Melee_Prediction", "移动 预判").SetValue(false));
            menu.AddSubMenu(menuMelee);

            var menuModes = new Menu("走砍 模式", "orb_Modes");
            {
                var modeCombo = new Menu("连 招", "orb_Modes_Combo");
                modeCombo.AddItem(new MenuItem("Combo_Key", "按键").SetValue(new KeyBind(32, KeyBindType.Press)));
                ...
                modeHarass.AddItem(new MenuItem("Harass_Key", "按键").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneClear.AddItem(new MenuItem("LaneClear_Key", "按键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneFreeze.AddItem(new MenuItem("LaneFreeze_Key", "按键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLasthit.AddItem(new MenuItem("LastHit_Key", "按键").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeFlee.AddItem(new MenuItem("Flee_Key", "按键").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                menuModes.AddSubMenu(modeFlee);
            }
            menu.AddSubMenu(menuModes);
            menu.AddItem(new MenuItem("xSLx_info2", "作者: xSLx & Esk0r"));
            menu.AddItem(new MenuItem("Huabian", "汉化人员:花边下丶情未央"));
            menu.AddItem(new MenuItem("ErGouQQqun", "QQ群:361630847"));
