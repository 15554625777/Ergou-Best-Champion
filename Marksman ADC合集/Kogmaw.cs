...
namespace Marksman
{
    internal class Kogmaw : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "R 限制人數").SetValue(new Slider(3, 5, 1)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "使用 E").SetValue(false));
            config.AddItem(new MenuItem("UseRH" + Id, "使用 R").SetValue(true));
            config.AddItem(new MenuItem("RlimH" + Id, "R 限制人數").SetValue(new Slider(1, 5, 1)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q 範圍").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W 範圍").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E 範圍").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawR" + Id, "R 範圍").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseRM" + Id, "使用 R 抢人头").SetValue(true));
            return true;
        }
