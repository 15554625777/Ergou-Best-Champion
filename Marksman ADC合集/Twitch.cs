...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "使用 E 最大層數").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "使用 E 最大層數").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawW" + Id, "W 範圍").SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
            return true;
        }

        public override bool MiscMenu(Menu config)
        {
            config.AddItem(new MenuItem("UseEM" + Id, "使用 E 搶人頭").SetValue(true));
            return true;
        }
