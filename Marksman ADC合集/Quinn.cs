...
namespace Marksman
{
    internal class Quinn : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETC" + Id, "塔下禁用E").SetValue(true));
            config.AddItem(new MenuItem("UseETK" + Id, "敌人可击杀|塔下使用E")
                .SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETH" + Id, "塔下禁用E").SetValue(true));
            config.AddItem(
