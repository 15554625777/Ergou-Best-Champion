...
namespace Marksman
{
    internal class Varus : Champion
    {
        ...
        {
            config.AddItem(
                new MenuItem("UseQH" + Id, "Q 施放").SetValue(
                    new StringList(new[] {"禁用", "任何时间", "W枯萎效果", "3层W枯萎效果"}, 3)));
            ...
            config.AddItem(
                new MenuItem("UseETH" + Id, "使用 E (自動)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));             
        ...
        public override bool MiscMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("CastR" + Id, "手動 R").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
        ...
        {
            config.AddItem(new MenuItem("DrawQ" + Id, "Q 範圍").SetValue(new Circle(true, Color.DarkGray)));
            config.AddItem(new MenuItem("DrawE" + Id, "E 範圍").SetValue(new Circle(true, Color.DarkGray)));
            config.AddItem(new MenuItem("DrawR" + Id, "R 範圍").SetValue(new Circle(true, Color.DarkGray)));
