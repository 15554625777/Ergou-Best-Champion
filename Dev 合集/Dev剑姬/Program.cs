    ...
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev鍓戝К v{0} 鍔犺級鎴愬姛锛佹饥鍖朾y鑺辫竟  浜岀嫍QQ缇361630847</font", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        {
            Config = new Menu("Dev剑姬", "DevFiora", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinHit", "用 大招 人數").SetValue(new Slider(2, 0, 5)));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinKill", "用 大招 殺人").SetValue(new Slider(1, 0, 5)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("ManaHarass", "最低 騷擾 藍量").SetValue(new Slider(30, 1, 100)));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "最低 清線 藍量").SetValue(new Slider(30, 1, 100)));

            Config.AddSubMenu(new Menu("雜 項", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "使用 封包").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseWAgainstAA", "用WA 再 AA").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseWAfterAttack", "用 W 之後 攻擊").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseEAfterAttack", "用 E 之後 攻擊").SetValue(true));
