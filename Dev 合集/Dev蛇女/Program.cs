...
namespace DevCassio
{
    class Program
    {
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseAACombo", "使用 走砍").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRSaveYourself", "使用 R保護自己").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRSaveYourselfMinHealth", "使用R保護最低生命值").SetValue(new Slider(25, 0, 100)));

            Config.AddSubMenu(new Menu("騷擾", "Harass"));
            Config.SubMenu("Harass").AddItem(new MenuItem("HarassToggle", "啟用騷擾 (自動)").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            Config.AddSubMenu(new Menu("控線", "Freeze"));
            Config.SubMenu("Freeze").AddItem(new MenuItem("UseEFreeze", "使用 E").SetValue(true));

            Config.AddSubMenu(new Menu("清線", "LaneClear"));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("UseELastHitLaneClear", "使用 E 補刀").SetValue(true));
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearMinMana", "清線最低藍量").SetValue(new Slider(25, 0, 100)));
            ...
            Config.AddSubMenu(new Menu("防止突進", "Gapcloser"));
            Config.SubMenu("Gapcloser").AddItem(new MenuItem("RAntiGapcloser", "使用R防止突進").SetValue(true));
            Config.SubMenu("Gapcloser").AddItem(new MenuItem("RInterrupetSpell", "使用R中斷法術").SetValue(true));
            Config.SubMenu("Gapcloser").AddItem(new MenuItem("RAntiGapcloserMinHealth", "使用R|突進者的血量").SetValue(new Slider(60, 0, 100)));

            Config.AddSubMenu(new Menu("雜項", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "使用反向E(使用封包)").SetValue(true));

            Config.AddSubMenu(new Menu("E 設置", "Legit"));
            Config.SubMenu("Legit").AddItem(new MenuItem("PlayLegit", "E 設置").SetValue(false));
            Config.SubMenu("Legit").AddItem(new MenuItem("DisableNFE", "禁用反向E").SetValue(true));
            Config.SubMenu("Legit").AddItem(new MenuItem("LegitCastDelay", "使用E延遲").SetValue(new Slider(500, 0, 1500)));

            Config.AddSubMenu(new Menu("R 設置", "Ultimate"));
            ...
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UseUltUnderTower", "塔下自動R敵人").SetValue(true));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UltRange", "使用 R 範圍").SetValue(new Slider(700, 0, 850)));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("RMinHit", "使用 R 人數").SetValue(new Slider(2, 1, 5)));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("RMinHitFacing", "使用 R 人數（正對)").SetValue(new Slider(1, 1, 5)));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("EDamage", "顯示E對敵人血量傷害").SetValue(true));
