    ...
    class Program
    {
        ...
        private static void onGameLoad(EventArgs args)
        {
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev鍥惧 鍔犺級鎴愬姛! v{0}姹夊寲by浜岀嫍!QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config = new Menu("Dev图奇", "DevTwitch", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("MinPassiveStackUseECombo", "使用E最大层数|").SetValue(new Slider(3, 1, 6)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("MinPassiveStackUseEHarass", "使用E最大层数").SetValue(new Slider(2, 1, 6)));
            Config.SubMenu("Harass").AddItem(new MenuItem("ManaHarass", "骚扰最低蓝量").SetValue(new Slider(50, 1, 100)));
            ...
            Config.SubMenu("KillSteal").AddItem(new MenuItem("EKillSteal", "E 抢人头").SetValue(true));
            Config.SubMenu("KillSteal").AddItem(new MenuItem("RKillSteal", "R 抢人头").SetValue(true));
            ...
            //Config.SubMenu("GapCloser").AddItem(new MenuItem("QGapCloser", "敌人突进使用Q").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloser", "阻断突进者").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloserMinHealth", "阻断突进者|最低血量").SetValue(new Slider(40, 0, 100)));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("RDamage", "显示R伤害").SetValue(true));
