...
namespace DevLulu
{
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat(string.Format("Dev闇查湶 鍔犺級鎴愬姛!: THIS ASSEMBLY IS NOT FINISHED YET!!!姹夊寲by浜岀嫍!QQ缇361630847</font>"));
        }
        ...
        {
            Config = new Menu("Dev露露", "DevLulu", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEQCombo", "对远处敌人使用EQ").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseEQHarass", "对远处敌人使用EQ").SetValue(true));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "清线最低蓝量").SetValue(new Slider(25, 1, 100)));

            Config.AddSubMenu(new Menu("控线", "Freeze"));
            Config.SubMenu("Freeze").AddItem(new MenuItem("UseQFreeze", "使用 Q 补刀").SetValue(true));
            Config.SubMenu("Freeze").AddItem(new MenuItem("ManaFreeze", "混合最低蓝量").SetValue(new Slider(25, 1, 100)));

            Config.AddSubMenu(new Menu("R设置", "Ultimate"));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UseRAlly", "对队友使用R").SetValue(true));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UseRAllyMinHealth", "使用R|队友血量").SetValue(new Slider(30, 1, 100)));

            Config.AddSubMenu(new Menu("支援队友", "HelpAlly"));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("UseWHelpAlly", "使用 W").SetValue(true));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("UseEHelpAlly", "使用 E").SetValue(true));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("AllyMinHealth", "支援队友最低血量").SetValue(new Slider(50, 1, 100)));
            ...
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WGapCloser", "使用W防止突进").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WInterruptSpell", "使用W中断法术").SetValue(true));
