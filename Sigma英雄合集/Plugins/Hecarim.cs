...
namespace SigmaSeries.Plugins
{
    public class Hecarim : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("wHP", "使用 W 血量").SetValue(new Slider(40, 1)));
        ...
        {
            config.AddItem(
                new MenuItem("useQFarm", "使用 Q").SetValue(new StringList(new[] {"控线", "清线", "同时", "禁用"}, 1)));
            config.AddItem(
                new MenuItem("useWFarm", "使用 W").SetValue(new StringList(new[] {"控线", "清线", "同时", "禁用"}, 3)));
            config.AddItem(
        ...
        private void actiontobedelayed(Menu config)
        {
            ...
            config.AddItem(new MenuItem("Interrupter", "中断 法术"));
