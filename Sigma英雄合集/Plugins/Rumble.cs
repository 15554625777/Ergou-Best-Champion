...
namespace SigmaSeries.Plugins
{
    public class Rumble : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("castR", "手动 R!").SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
        }
        ...
        public override void FarmMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("useEFarm", "使用 E").SetValue(new StringList(new[] { "控线", "清线", "同时", "禁用" }, 0)));
        ...
        public override void BonusMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("keepHeat", "保持 热能").SetValue(new KeyBind("M".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(new MenuItem("keepHeatQ", "使用 Q 维持热能").SetValue(false));
            config.AddItem(new MenuItem("keepHeatW", "使用 W 维持热能").SetValue(true));
            config.AddItem(new MenuItem("KSE", "抢人头 使用 E").SetValue(true));
        }
