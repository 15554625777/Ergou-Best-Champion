...
namespace SigmaSeries.Plugins
{
    public class FiddleSticks : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("sep", "当使用W时, 它将被阻止"));
            config.AddItem(new MenuItem("sep2", "封包点击3次才施放"));
        }
        ...
        public override void FarmMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("useEFarm", "使用 E").SetValue(new StringList(new[] { "控线", "清线", "同时", "禁用" }, 1)));
