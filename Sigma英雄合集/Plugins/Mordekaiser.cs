...
namespace SigmaSeries.Plugins
{
    public class Mordekaiser : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("controlMinion", "控制 复活者").SetValue(true));
            config.AddItem(new MenuItem("forceR", "强行使用 R").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
        }
