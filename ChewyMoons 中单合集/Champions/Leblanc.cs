...
namespace Mid_or_Feed.Champions
{
    internal class Leblanc : Plugin
    {
        ...
        public override void Combo(Menu comboMenu)
        {
            ...
            comboMenu.AddItem(new MenuItem("useWBack", "W/R返回|敌人死亡").SetValue(true));
        ...
        public override void Harass(Menu harassMenu)
        {
            ...
            harassMenu.AddItem(new MenuItem("useWBackHarass", "W 返回").SetValue(true));
        }
        ...
        {
            miscMenu.AddItem(new MenuItem("eGapcloser", "E 防止突进").SetValue(true));
            miscMenu.AddItem(new MenuItem("eInterrupt", "E 中断法术").SetValue(true));
        }

        public override void Drawings(Menu drawingMenu)
        {
            drawingMenu.AddItem(new MenuItem("drawQ", "范围 Q").SetValue(true));
            drawingMenu.AddItem(new MenuItem("drawW", "范围 W").SetValue(true));
