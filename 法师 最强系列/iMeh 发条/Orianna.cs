...
namespace Orianna
{
    internal class Orianna
    {
        ...
        static Orianna()
        {
            ...
            //Create the menu
            Config = new Menu("iMeh 发条", "Orianna", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRComboKillable", "使用 R 如果可击杀").SetValue(true));
            Config.SubMenu("Combo")
                .AddItem(new MenuItem("UseRComboCount", "使用 R 命中单位").SetValue(new Slider(2, 1, 5)));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseIgniteCombo", "使用 点燃").SetValue(true));
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboActive", "连招 键位!").SetValue(
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActive", "骚扰 键位!").SetValue(
                        new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActiveT", "骚扰 (自动)!").SetValue(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("FreezeActive", "控线 键位!").SetValue(
                        new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("LaneClearActive", "清线 键位!").SetValue(
            ...
            Config.SubMenu("JungleFarm")
                .AddItem(
                    new MenuItem("JungleFarmActive", "清野 键位!").SetValue(
                        new KeyBind(Config.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            Config.AddSubMenu(new Menu("杂项", "Mixed"));
            Config.SubMenu("Mixed").AddItem(new MenuItem("UseRInterrupt", "使用R中断法术").SetValue(true));
