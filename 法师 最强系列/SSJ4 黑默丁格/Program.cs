...
namespace SSJ4_Heimerdinger
{
    internal class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Menu
            Config = new Menu(Champion, "SSJ4 黑默丁格 2.0", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("KS", "抢人头")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("ZhoUlt", "大招 + Q > 中亚")).SetValue(true);
            ...
            Game.PrintChat("SSJ4 榛戦粯涓佹牸 2.0 鍔犺級鎴愬姛!婕㈠寲by浜岀嫍!QQ缇361630847!");
        }
