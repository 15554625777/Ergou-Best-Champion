...
namespace BlackKassadin
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            // Print
            Game.PrintChat(
                String.Format("<font color='#08F5F8'>black|鍗¤惃涓亅 -</font> <font color='#FFFFFF'>{0} 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847!</font>",
                    ChampName));
        }
        ...
        {
            Menu = new Menu("Black 卡萨丁", "black" + ChampName, true);
            ...
            waveclear.AddItem(new MenuItem("wcMana", "M清线最低蓝量").SetValue(new Slider(40, 100, 0)));
            waveclear.AddItem(new MenuItem("wcActive", "清线键位!").SetValue(new KeyBind('V', KeyBindType.Press)));
            ...
            misc.AddItem(new MenuItem("miscUltToMouse", "手动大招").SetValue(new KeyBind('G', KeyBindType.Press)));
            misc.AddItem(new MenuItem("miscUseR", "手动向鼠标方向大招").SetValue(true));
            misc.AddItem(new MenuItem("miscUltStacks", "限制堆叠层数")).SetValue(new Slider(3, 1, 4));
