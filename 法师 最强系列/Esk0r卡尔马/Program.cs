...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEDefense", "使用 E 抵挡伤害").SetValue(true));
            ...
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("WRootRange", "W 根 范围").SetValue(new Circle(true, Color.MintCream)));
