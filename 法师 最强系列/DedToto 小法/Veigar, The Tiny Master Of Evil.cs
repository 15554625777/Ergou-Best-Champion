...
namespace Veigar__The_Tiny_Master_Of_Evil
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Menu
            menu = new Menu("DedToto 小法", "Veigar", true);
            ...
            //Keys & Combo Related
            menu.AddSubMenu(new Menu("键位 设置", "Keys"));
            menu.SubMenu("Keys");
            menu.SubMenu("Keys").AddItem(new MenuItem("Combo", "连招").SetValue(new KeyBind(32, KeyBindType.Press, false)));
            menu.SubMenu("Keys").AddItem(new MenuItem("AllInActive", "交出所有技能").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            menu.SubMenu("Keys").AddItem(new MenuItem("HarassActive", "骚扰").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
            menu.SubMenu("Keys").AddItem(new MenuItem("Stun Closest Enemy", "眩晕最近敌人").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press, false)));
            menu.SubMenu("Keys").AddItem(new MenuItem("LastHitQQ", "补刀 Q[自动]").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Keys").AddItem(new MenuItem("LastHitQ", "补刀 Q[保持]").SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Press, false)));
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("ExtraNeeded", "显示组合连招伤害").SetValue(new KeyBind("N".ToCharArray()[0], KeyBindType.Toggle, true)));
            menu.SubMenu("Keys").AddItem(new MenuItem("InfoTable", "显示信息表格[FPS]").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Toggle)));

            //Drawings menu:
            menu.AddSubMenu(new Menu("显示 设置", "Drawings"));
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDdisplay", "游戏的状态显示").SetValue(true));
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDX", "X 坐标轴").SetValue(new Slider(67, 0, 100)));
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDY", "Y 坐标轴").SetValue(new Slider(86, 0, 100)));
            ...
            menu.SubMenu("Drawings").AddItem(new MenuItem("MinionMarker", "Q补刀提示").SetValue(new Circle(true, Color.Green)));
            menu.SubMenu("Drawings").AddItem(new MenuItem("TText", "显示范围内攻击目标").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("LText", "显示目标[HP BAR]").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("ExtraNeeded1", "显示目标HP指示器").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("OptimalCombo", "显示最佳组合连招[FPS]").SetValue(false));

            //Mana Manager menu:
            menu.AddSubMenu(new Menu("控魔 管理", "manam"));
            menu.SubMenu("manam").AddItem(new MenuItem("manaStatus", "启用控魔状态").SetValue(true));
            menu.SubMenu("manam").AddItem(new MenuItem("wusage", "清线魔量 > (%)").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("qusage", "Q 补刀魔量 > (%)").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("husage", "骚扰魔量 > (%)").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveEW", "保存清线魔量设定").SetValue(false));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveE", "保存Q补刀魔量设定").SetValue(false));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveEH", "保存骚扰魔量设定").SetValue(false));

            //Misc menu:
            menu.AddSubMenu(new Menu("其它 设置", "Other"));
            menu.SubMenu("Other").AddSubMenu(new Menu("自动W设置", "wsets"));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("Wimm", "自动W眩晕目标").SetValue(true));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("Wimmz", "单独使用W当其它技能未冷却").SetValue(true));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("DontWimm", "连招前禁用自动W").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("StunUnderTower", "自动眩晕塔下敌人").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("UseInt", "使用E 中断法术").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("UseGap", "使用E 防止突进").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("PotOnIGN", "点燃时自动吃药").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("buystart", "自动购买出门装").SetValue(new KeyBind("P".ToCharArray()[0], KeyBindType.Press, false)));
            menu.SubMenu("Other").AddItem(new MenuItem("Reset", "自动锁定目标").SetValue(new KeyBind("L".ToCharArray()[0], KeyBindType.Press, false)));
            menu.SubMenu("Other").AddItem(new MenuItem("packet", "使用封包").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("Show", "显示子画面").SetValue(true));
            ...
            //Notifications
            menu.AddSubMenu(new Menu("通知 设置", "notes"));
            menu.SubMenu("notes").AddItem(new MenuItem("noteactive", "开启通知文本").SetValue(true));
            menu.SubMenu("notes").AddItem(new MenuItem("notems", "通知：你的连招伤害<目标连招伤害").SetValue(true));
            menu.SubMenu("notes").AddItem(new MenuItem("notebuffs", "通知：目标buff").SetValue(false));
            menu.SubMenu("notes").AddItem(new MenuItem("notetenacity", "通知：E眩晕 < W 延迟").SetValue(true));


            //Farm menu:
            menu.AddSubMenu(new Menu("补刀 设置", "Farm"));
            menu.SubMenu("Farm").AddItem(new MenuItem("dontfarm", "连招前禁用Q补刀").SetValue(true));
            menu.SubMenu("Farm").AddItem(new MenuItem("OnlySiege", "只补大炮车").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("WAmount", "W清线 小兵数量").SetValue(new Slider(3, 1, 7)));
            menu.SubMenu("Farm").AddItem(new MenuItem("FarmMove", "鼠标跟随").SetValue(new StringList(new[] { "移动接近", "清线", "Q 补刀", "清线 & Q 补刀" }, 0)));

            //Jungle Farm menu:
            menu.AddSubMenu(new Menu("清线 设置", "Jungle Clear"));
            ...
            //Auto KS
            menu.AddSubMenu(new Menu("自动抢人头", "AutoKS"));
            ...
            menu.SubMenu("AutoKS").AddItem(new MenuItem("DisableKS", "连招前禁用自动抢人头").SetValue(false));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("HarassMode", "选择骚扰类型：").SetValue(new StringList(new[] { "E+W+Q", "E+W", "Q", "禁用" }, 0)));
            menu.SubMenu("Harass").AddItem(new MenuItem("WaitW", "先Q后W").SetValue(false));

            //Combo menu:
            menu.AddSubMenu(new Menu("连招 设置", "Combo"));
            menu.SubMenu("Combo").AddItem(new MenuItem("LockTargets", "左键点击目标锁定").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("DontEShields", "敌人有魔法护盾禁用E").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("ToOrb", "[内置]连招使用走砍").SetValue(false));
            menu.SubMenu("Combo").AddItem(new MenuItem("CastMode", "E 和 W 设置").SetValue(new StringList(new[] { "先W后E", "先E后W", }, 0)));
            menu.SubMenu("Combo").AddSubMenu(new Menu("智能连招设置", "MainCombo"));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("ComboWaitMode", "选择连招模式:").SetValue(new StringList(new[] { "Wait for W to land first", "Don't wait for W to land", }, 0)));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreQ", "W未命中允许使用Q").SetValue(false));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreR", "W未命中允许使用R").SetValue(false));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreIGN", "W未命中允许使用点燃").SetValue(false));

            menu.SubMenu("Combo").SubMenu("MainCombo").AddSubMenu(new Menu("目标击杀 %", "op"));
            ...
            menu.SubMenu("Combo").SubMenu("MainCombo").AddSubMenu(new Menu("连招忽略：", "il"));
            foreach (var enemy in ObjectManager.Get<Obj_AI_Hero>().Where(enemy => enemy.Team != Player.Team))
            ...
            menu.SubMenu("Combo").SubMenu("MainCombo").AddItem(new MenuItem("Priority", "保存优先权").SetValue(new StringList(new[] { "点燃 > R", "R > 点燃" }, 0)));
            menu.SubMenu("Combo").SubMenu("MainCombo").AddItem(new MenuItem("ComboMode", "不可击杀连招设置").SetValue(new StringList(new[] { "禁用连招", "选择骚扰", "Q", "E+W", "E+W+Q", }, 0)));
            menu.SubMenu("Combo").AddSubMenu(new Menu("禁用点燃R 目标：", "DontRIGN"));
            foreach (var buff in buffList)
                menu.SubMenu("Combo").SubMenu("DontRIGN").AddItem(new MenuItem("dont" + buff.Name, buff.MenuName).SetValue(true));
            foreach (var buff in IgnoreList.Where(buff => buff.MenuName != "轮子妈 E" && buff.MenuName != "小鱼人 E" && buff.MenuName != "吸血鬼 W"))
                menu.SubMenu("Combo").SubMenu("DontRIGN").AddItem(new MenuItem("dont" + buff.Name, buff.MenuName).SetValue(true));
            menu.SubMenu("Combo").SubMenu("DontRIGN").AddItem(new MenuItem("YasuoWall", "亚索风墙").SetValue(true));
            ...
            Game.PrintChat("DedToto 灏忔硶 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847");
        }
